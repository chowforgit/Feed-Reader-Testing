    ...
    */
    ...
    describe('The menu', function() {
        ...
        it('is default hidden', function() {
          ...
          * 再次点击的时候是否隐藏。
          */
        it('would toggle visible/hidden when clicked', function() {
            menuIcon.click();
    ...
    describe('Initial Entries', function() {
         ...
         * 和异步的 done() 函数。
         */
         it('should have alleast one entry when loaded', function(done) {
    ...
    describe('New Feed Selection', function() {
         ...
         * 记住，loadFeed() 函数是异步的。
         */
        it('would change the content when reloaded', function(done) {
            loadFeed(1,function() {
